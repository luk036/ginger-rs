...
mod test {
    ...
    fn test_scale() {
        ...
        assert_eq!(
            m2.scale(2.0),
            Matrix2::new(Vector2::new(3.0, 5.0), Vector2::new(7.0, 9.0))
        );
    }
    ...
    fn test_unscale() {
        ...
        assert_eq!(
            m.unscale(10),
            Matrix2::new(Vector2::new(3, 4), Vector2::new(5, 6))
        );

        let m2 = Matrix2::new(Vector2::new(3.0, 5.0), Vector2::new(7.0, 9.0));
        assert_eq!(
            m2.unscale(2.0),
            Matrix2::new(Vector2::new(1.5, 2.5), Vector2::new(3.5, 4.5))
        );
    }
    ...
    fn test_sub() {
        ...
        assert_eq!(
            m1 - m2,
            Matrix2::new(Vector2::new(4, 4), Vector2::new(4, 4))
        );
    ...
    fn test_scalar_mul() {
        ...
        assert_eq!(
            m * 4,
            Matrix2::new(Vector2::new(8, 12), Vector2::new(16, 20))
        );
        assert_eq!(
            &m * 4,
            Matrix2::new(Vector2::new(8, 12), Vector2::new(16, 20))
